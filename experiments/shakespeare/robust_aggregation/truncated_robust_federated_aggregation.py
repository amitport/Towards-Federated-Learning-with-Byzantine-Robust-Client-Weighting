...
from experiments.shakespeare.robust_aggregation.robust_federated_aggregation import RobustWeiszfeldFactory
  ...
  def __init__(self, num_communication_passes=5, tolerance=1e-6, U=None):
    ...
    Args:
      ...
      tolerance: Smoothing parameter of smoothed Weiszfeld algorithm. Default
        1e-6.
    """
    super().__init__(num_communication_passes, tolerance)
    self._U = U
